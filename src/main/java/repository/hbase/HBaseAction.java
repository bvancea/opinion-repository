...
public class HBaseAction {
	...
	String tableName = "likes2";
	String cellValue = "repository content";
	...
	private void scanData() {
		java.util.List<String> results = t.find(tableName, columnFamilyName, linkAddress, new RowMapper<String>() {
